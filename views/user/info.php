...
<div id="content" class="col-lg-10 col-sm-10">
	...
	<div class="article-create">
    	...
    	<div class="article-form">
	    	<form id="w0" action="user/info" method="post" enctype="multipart/form-data">
	    	...
	    	<div class="form-group field-article-title required">
	    		<label class="control-label" for="article-title">姓名</label>
	    		<input type="text" id="name" class="form-control" name="name" maxlength="255" value="<?=$info['name']?>">
	    	</div>
	    	<div class="form-group field-article-title required">
	    	...
	    	<div class="form-group field-article-title required">
	    		<label class="control-label" for="article-title">手机</label>
	    		<input type="text" id="phone" class="form-control" name="phone" maxlength="255" value="<?=$info['phone']?>">
	    	</div>
	    	<div class="form-group field-article-title required">
